...
export function EmptyTarget() {
  ...
  return (
    <div className="flex grow flex-col items-center justify-center p-4 pb-2 lg:rounded-lg lg:bg-white lg:p-6 lg:pb-2 lg:shadow-sm lg:ring-1 lg:ring-stone-950/5 lg:dark:bg-zinc-900 lg:dark:ring-white/10">
      <div className="flex max-w-lg flex-col items-center text-center">
        <LanguageIcon className="text-zinc-400 dark:text-zinc-500" width={48} />
